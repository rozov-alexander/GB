...
function handleClick(clickedButtonEvent) {
    ...
    let text = cardNode.childNodes[5].innerText
...
function hideMoreText(card) {
    ...
    let desc = card.wrap.getElementsByClassName('desc');
    desc[0].remove();
